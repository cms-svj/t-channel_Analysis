...
output_directory = f"/home/keanet/uscmshome/nobackup/SVJ/eventLevelTagger/output/dataset6_QCD_pn/training_set1"
...
output_prepared_files = output_directory + "/data/"
...
output_analysis = output_directory + "/analysis_results/"
