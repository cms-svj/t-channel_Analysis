...
__n_jets_max = 5
__index_triplets = [(idx1, idx2, idx3) for idx1 in range(__n_jets_max) for idx2 in range(idx1+1, __n_jets_max) for idx3 in range(idx2+1, __n_jets_max)]
