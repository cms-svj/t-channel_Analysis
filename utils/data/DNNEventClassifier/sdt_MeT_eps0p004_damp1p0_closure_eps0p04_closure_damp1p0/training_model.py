...
__config_training_options = f"configs.{__config}.training_options"
__opt_training_options = import_module(__config_training_options)
__features_training = __opt_training_options.features_training

hl1 = 64
hl2 = 32
hl3 = 16
hl4 = 8
features = len(__features_training)
