...
parameters_scans = {
    ...
    "mMed" : [f"2018_training_t-channel_mMed-{x}_mDark-20_rinv-0p3_alpha-peak_yukawa-1" for x in [1000, 2000, 3000, 4000]],
    "rinv" : [f"2018_training_t-channel_mMed-2000_mDark-20_rinv-{x}_alpha-peak_yukawa-1" for x in ["0p1", "0p3", "0p5", "0p7"]],
