...
'jdeepDoubleBDiscriminatorHAK8':          ["deepDoubleBDiscriminatorH(J)",                     100,    0.0,    1.0,         1,     1],
'jdeepDoubleBDiscriminatorQAK8':          ["deepDoubleBDiscriminatorQ(J)",                     100,    0.0,    1.0,         1,     1],
...
'jhDiscriminatorDeepAK8':                 ["hDiscriminatorDeep(J)",                            100,    0.0,    1.0,         1,     1],
'jLeanAK8':                               ["lean(J)",                                          100,    0.0,    1.0,         1,     1],
'jMomentHalfAK8':                         ["momenthalf(J)",                                    100,    0.0,    1.0,         1,     1],
...
'jPtdrlogAK8':                            ["ptdrlog(J)",                                       500,    0.0,    1000.0,      1,     1],
...
'jtDiscriminatorDeepAK8':                 ["tDiscriminatorDeep(J)",                            100,    0.0,    1.0,         1,     1],
'jwDiscriminatorDeepAK8':                 ["wDiscriminatorDeep(J)",                            100,    0.0,    1.0,         1,     1],
'jzDiscriminatorDeepAK8':                 ["zDiscriminatorDeep(J)",                            100,    0.0,    1.0,         1,     1],
