...
def variables(jNVar=False, maxN = 3):
    ...
    allVars = {
        ...
        'jPt':                     SVJHistoInfo("jPt",                      h.axis.Regular(name="x", label=r"$p_{T}$ [GeV]",                                 bins=400,   start= 0.0,    stop=4000.0),     0,     1,       'jw'  ),
        ...
        'jAxismajor':              SVJHistoInfo("jAxismajor",               h.axis.Regular(name="x", label=r"$\sigma_{major}(j)$",                           bins=40,    start= 0.0,    stop=0.8   ),     0,     1,       'jw'  ),
        ...
        'jPtAK8':                  SVJHistoInfo("jPtAK8",                   h.axis.Regular(name="x", label=r"$p_{T}$ [GeV]",                                 bins=400,   start= 0.0,    stop=4000.0),     1,     1,       'fjw' ),
        ...
        'jAxismajorAK8':           SVJHistoInfo("jAxismajorAK8",            h.axis.Regular(name="x", label=r"$\sigma_{major}(J)$",                           bins=40,    start= 0.0,    stop=0.8   ),     1,     1,       'fjw' ),
    ...
    if jNVar:
        ...
        for i in range(maxN):
            jNList = {
                ...
                'j{}AxismajorAK8'.format(i+1):    SVJHistoInfo('j{}AxismajorAK8'.format(i+1),     h.axis.Regular(name="x", label=r"$\sigma_{major}(J_"+str(i+1)+")$",      bins=40,    start= 0.0,    stop=0.8   ),       2,     0,       'evtw'),
