...
def variables(jNVar=False):
    ...
    allVars = {
        ...
        'evtw':                    SVJHistoInfo("evtw",                     h.axis.Regular(name="x", label="h_evtw",                                         bins= 2,    start=-1.1,    stop=1.1   ),     0,     0,       'evtw'),
        ...
        'metPhi':                  SVJHistoInfo("metPhi",                   h.axis.Regular(name="x", label=r"MET $\phi$ [GeV]",                              bins=40,    start=-4.0,    stop=4.0   ),     0,     0,       'evtw'),
        # 'madHT':                 SVJHistoInfo("madHT",                    h.axis.Regular(name="x", label=r"$H_{T}$ (GeV)",                                 bins=500,   start= 0.0,    stop=5000.0),     2,     0,       'evtw'),
        'jPt':                     SVJHistoInfo("jPt",                      h.axis.Regular(name="x", label=r"$p_{T}$ [GeV]",                                 bins=200,   start= 0.0,    stop=2500.0),     0,     1,       'jw'  ),
        'jEta':                    SVJHistoInfo("jEta",                     h.axis.Regular(name="x", label=r"$\eta$",                                        bins=200,   start=-6.0,    stop=6.0   ),     0,     1,       'jw'  ),
        'jPhi':                    SVJHistoInfo("jPhi",                     h.axis.Regular(name="x", label=r"$\phi$",                                        bins=200,   start=-4.0,    stop=4.0   ),     0,     1,       'jw'  ),
        ...
        'jPtAK8':                  SVJHistoInfo("jPtAK8",                   h.axis.Regular(name="x", label=r"$p_{T}$ [GeV]",                                 bins=280,   start= 0.0,    stop=2800.0),     1,     1,       'fjw' ),
        'jEtaAK8':                 SVJHistoInfo("jEtaAK8",                  h.axis.Regular(name="x", label=r"$\eta$",                                        bins=200,   start=-6.0,    stop=6.0   ),     1,     1,       'fjw' ),
        'jPhiAK8':                 SVJHistoInfo("jPhiAK8",                  h.axis.Regular(name="x", label=r"$\phi$",                                        bins=200,   start=-4.0,    stop=4.0   ),     1,     1,       'fjw' ),
        ...
        'jdoubleBDiscriminatorAK8':SVJHistoInfo("jdoubleBDiscriminatorAK8", h.axis.Regular(name="x", label="doubleBDiscriminator(J)",                        bins=100,   start= -1.0,   stop=1.0   ),     1,     1,       'fjw' ),
        ...
        'jNumBhadronsAK8':         SVJHistoInfo("jNumBhadronsAK8",          h.axis.Regular(name="x", label="nBHad(J)",                                       bins=30,    start= 0.0,    stop=30.0  ),     1,     1,       'fjw' ),
        'jNumChadronsAK8':         SVJHistoInfo("jNumChadronsAK8",          h.axis.Regular(name="x", label="nCHad(J)",                                       bins=30,    start= 0.0,    stop=30.0  ),     1,     1,       'fjw' ),
        ...
        # "GenJetsAK8_hvCategory": SVJHistoInfo("GenJetsAK8_hvCategory",    h.axis.Regular(name="x", label="GenJetAK8 hvCategory",                           bins=32,    start= 0.0,    stop=32.0  ),     0,     1,        'fjw'),
        ...
        'svjPtAK8':                SVJHistoInfo("svjPtAK8",                 h.axis.Regular(name="x", label=r"$p_{T}$ [GeV]",                                 bins=280,   start= 0.0,    stop=2800.0),     1,     1, 'svfjw'     ),
        'svjEtaAK8':               SVJHistoInfo("svjEtaAK8",                h.axis.Regular(name="x", label=r"$\eta$",                                        bins=200,   start=-6.0,    stop=6.0   ),     1,     1, 'svfjw'     ),
    }
    if jNVar:
