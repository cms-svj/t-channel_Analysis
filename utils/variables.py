...
def variables(jNVar=False, maxN = 3):
    ...
    histos2D = {
        ...
        'METvsDNN': SVJHistoInfo(varXName='MET', varYName='nnEventOutput',npzInfo=0, flattenInfo=0, weightName='evtw', 
                                        xbins=h.axis.Regular(name="x", label="MET [GeV]",      bins=300, start=0.0, stop=2000.0), ybins=h.axis.Regular(name="y", label="nnEventOutput",  bins=100, start=0.0, stop=1.0 )),
        ...
        'nNMedEventvsDNN': SVJHistoInfo(varXName='nNMedEvent', varYName='nnEventOutput',npzInfo=0, flattenInfo=0, weightName='evtw', 
                                        xbins=h.axis.Regular(name="x", label="N-Med Event",      bins=4, start=0.0, stop=4.0), ybins=h.axis.Regular(name="y", label="nnEventOutput",  bins=100, start=0.0, stop=1.0 )),
