...
def variables(jNVar=False, maxN = 3, runJetTag=True, runEvtClass=True):
    ...
    allVars = {
        ...
        'nelectrons':              SVJHistoInfo("nelectrons",               h.axis.Regular(name="x", label="Number of Electrons",                            bins=5,     start= 0.0,    stop=5.0   ),     2,     0,       'evtw'),
        'nmuons':                  SVJHistoInfo("nmuons",                   h.axis.Regular(name="x", label="Number of Muons",                                bins=5,     start= 0.0,    stop=5.0   ),     2,     0,       'evtw'),
