...
def var(jNVar=False):
    myVars = {
        ...
        # 'njetsAK8':       [ "Number of AK8 Jets", 15, 0.0, 15.0, 2, 0, 'evtw'],
        # # 'nb':             [ "Number of b",10, 0.0, 10.0, 2, 0, 'evtw'],
        # 'nl':             [ "Number of Leptons",  5, 0.0, 5.0, 2, 0, 'evtw'],
        # 'nelectrons':             [ "Number of Electrons",  5, 0.0, 5.0, 2, 0, 'evtw'],
        # 'nmuons':             [ "Number of Muons",  5, 0.0, 5.0, 2, 0, 'evtw'],
        ...
        # 'MET':            [ r"p_{T}^{miss} [GeV]", 500, 0.0, 2000.0, 2, 0, 'evtw'],
        ...
        # 'dPhiMinjMETAK8':          [ r"#Delta#phi_{min}(J,p_{T}^{miss})", 100, 0.0,   3.2   ,     2,     0,       'evtw'],
        ...
        # 'nnEventOutput':      ["nnEventOutput",       100,    0.0,    1.0   ,     0,     0, 'evtw'       ],
        # 'nnEventOutputrMET':  ["nnEventOutputrMET", 100,    0.0,    1.0   ,     0,     0, 'evtw'       ],
        # 'nnEventOutputrST':   ["nnEventOutputrST",        100,   0.0,  0.02  ,     0,     0, 'evtw'       ],
        ...
        # 'crElectronPT':             [r"p_{T}(crElectron) [GeV]",      100,    0.0,    500.0,     0,     1,       'crew'],
        # 'crElectronPhi':            [r"\phi (crElectron) ",           40,    -4.0,    4.0   ,     0,     1,       'crew'],
        # 'crElectronEta':             [r"\eta (crElectron)",            200,   -6.0,    6.0   ,     0,     1,       'crew' ],
        # 'crMuonPT':                  [r"p_{T}(crMuon) [GeV]",          100,    0.0,    500.0,     0,     1,       'crmw'],
        # 'crMuonPhi':                  [r"\phi (crMuon) ",               40,    -4.0,   4.0   ,     0,     1,       'crmw'],
        # 'crMuonEta':                 [r"\eta (crMuon)",                200,   -6.0,    6.0   ,     0,     1,       'crmw' ],
        # 'mtMETCRMuon':                 [r"$m_{T} (MET,crMuon) [GeV]$",                                 500,    0.0,    1000.0,     2,     0,       'evtw'],
        # 'mtMETCRElectron':              [r"$m_{T} (MET,crElectron) [GeV]$",                                 500,    0.0,    1000.0,     2,     0,       'evtw'],
        # 'dPhiMinJAK8crMuon1':            [r"$\Delta\phi_{min}(J,crMuon1)$",                     100,   0.0,    4.0   ,     0,     0,       'evtw'],
        # 'dPhiMinJAK8crElectron1':          [r"$\Delta\phi_{min}(J,crElectron1)$",                     100,    0.0,    4.0   ,     0,     0,       'evtw'],
        'pNetJetTaggerScore':      ["pNetJetTaggerScore", 100,    0.0,    1.0  ,     1,     1, 'fjw'       ],
        'dnnEventClassScore':      ["dnnEventClassScore",   100,  0.0,    1.0   ,     0,     0, 'evtw'       ],
    }
    ...
    if jNVar:
        ...
        for i in range(maxN):
            jNList = {
                ...
                # 'dRj{}AK8crMuon1'.format(i+1):     [r"$\Delta R(J_{"+str(i+1)+"},crMuon1)$",  100,  0.0,    4.0   ,       2,     0,       'evtw'],
                # 'dRj{}AK8crElectron1'.format(i+1): [r"$\Delta R(J_{"+str(i+1)+"},crElectron1)$", 100,    0.0,    4.0   ,       2,     0,       'evtw'],
