...
def main():
    ...
    nonclosure_0 = compute_nonclosure(obs_0_bg, pred_0_bg)
    nonclosure_1 = compute_nonclosure(obs_1_bg, pred_1_bg)
    nonclosure_2 = compute_nonclosure(obs_2_bg, pred_2_bg)
    nonclosure_3 = compute_nonclosure(obs_3_bg, pred_3_bg)

    MET_edges_plot = np.linspace(200, 1000, met_bins)
    DNN_edges_plot = np.linspace(0, 1, dnn_bins)

    plot_nonclosure_histogram(nonclosure_0, MET_edges_plot, DNN_edges_plot, 1, '0SVJ', f"{output_dir_pnet}/nonclosure_0SVJ.png")
    plot_nonclosure_histogram(nonclosure_1, MET_edges_plot, DNN_edges_plot, 1, '1SVJ', f"{output_dir_pnet}/nonclosure_1SVJ.png")
    plot_nonclosure_histogram(nonclosure_2, MET_edges_plot, DNN_edges_plot, 1, '2SVJ', f"{output_dir_pnet}/nonclosure_2SVJ.png")
    plot_nonclosure_histogram(nonclosure_3, MET_edges_plot, DNN_edges_plot, 1, '3PSVJ', f"{output_dir_pnet}/nonclosure_3PSVJ.png")
    ...
    plot_nonclosure_histogram(nonclosure_0, MET_edges_plot, DNN_edges_plot, 1, '0SVJ', f"{output_dir_wnae}/nonclosure_0SVJ.png")
    plot_nonclosure_histogram(nonclosure_1, MET_edges_plot, DNN_edges_plot, 1, '1SVJ', f"{output_dir_wnae}/nonclosure_1SVJ.png")
    plot_nonclosure_histogram(nonclosure_2, MET_edges_plot, DNN_edges_plot, 1, '2SVJ', f"{output_dir_wnae}/nonclosure_2SVJ.png")
    plot_nonclosure_histogram(nonclosure_3, MET_edges_plot, DNN_edges_plot, 1, '3PSVJ', f"{output_dir_wnae}/nonclosure_3PSVJ.png")
